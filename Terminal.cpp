...
namespace term {
    ...
    Window::Window(int x, int y, int w, int h, bool with_border, int px, int py) {
        if( with_border ) {
    ...
    int Window::getPx() const {
        return px;
    }

    int Window::getPy() const {
        return py;
    }
    ...
    Window Terminal::create_window(int x, int y, int w, int h, bool with_border, int px, int py) {
        return Window(x, y, w, h, with_border, px, py);
    }
