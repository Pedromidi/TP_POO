...
namespace term {
    ...
    class Window {
    public:
        Window(int x, int y, int w, int h, bool with_border=true, int px=0, int py=0);
        ...
        int getchar();
        [[nodiscard]] int getPx() const;
        [[nodiscard]] int getPy() const;
        void clear();
    ...
    public:
        ...
        Window create_window(int x, int y, int w, int h, bool with_border=true, int px=0, int py=0);
